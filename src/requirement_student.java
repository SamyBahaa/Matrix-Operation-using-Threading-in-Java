	 ...
	 public static void main(String... args) throws InterruptedException {
		 ...
		 * 3 threads for StoreBranches and name them: "Giza Branch", "Cairo Branch", and "Alex Branch".
	 	 */
			 ...
			 Thread Giza=new Thread(new StoreBranch(b));
			 Giza.setName("Giza Branch");
			 Thread Cairo=new Thread(new StoreBranch(b));
			 Cairo.setName("Cairo Branch");
			 Thread Alex=new Thread(new StoreBranch(b));
			 Alex.setName("Alex Branch");
...
class StoreBranch implements Runnable {
	...
	public void doWork () throws InterruptedException{
		while (true) {
			 ...
			 */
			synchronized (this) {while(b.getCount()==0)wait();}
			b.consume();
